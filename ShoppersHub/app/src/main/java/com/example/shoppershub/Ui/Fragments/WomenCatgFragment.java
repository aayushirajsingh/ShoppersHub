...
import com.example.shoppershub.databinding.FragmentWomenCatgBinding;
...
public class WomenCatgFragment extends Fragment implements ItemClick {

    FragmentWomenCatgBinding binding;

    public WomenCatgFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentWomenCatgBinding.inflate(inflater, container, false);
        View view = binding.getRoot();

        binding.rvWomencatg.setLayoutManager(new GridLayoutManager(getContext(),2));
    ...
    public void productsData()
    {
        ...
        Call<List<ProductsModel>> call = apiInterface.product_women();

        call.enqueue(new Callback<List<ProductsModel>>() {
            @Override
            public void onResponse(Call<List<ProductsModel>> call, Response<List<ProductsModel>> response) {
                List<ProductsModel> data = response.body();
                ItemsAdapter adapter = new ItemsAdapter(WomenCatgFragment.this::onItemClick,getContext(),data);
                binding.rvWomencatg.setAdapter(adapter);
            }
