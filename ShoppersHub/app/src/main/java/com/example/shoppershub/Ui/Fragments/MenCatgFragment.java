...
import com.example.shoppershub.databinding.FragmentMenCatgBinding;
...
public class MenCatgFragment extends Fragment implements ItemClick {

    FragmentMenCatgBinding binding;

    public MenCatgFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentMenCatgBinding.inflate(inflater , container, false);
        View view = binding.getRoot();

        binding.rvMencatg.setLayoutManager(new GridLayoutManager(getContext(),2));
    ...
    public void productsData()
    {
        ...
        Call<List<ProductsModel>> call = apiInterface.product_men();

        call.enqueue(new Callback<List<ProductsModel>>() {
            @Override
            public void onResponse(Call<List<ProductsModel>> call, Response<List<ProductsModel>> response) {
                List<ProductsModel> data = response.body();
                ItemsAdapter adapter = new ItemsAdapter(MenCatgFragment.this::onItemClick,getContext(),data);
                binding.rvMencatg.setAdapter(adapter);
            }
